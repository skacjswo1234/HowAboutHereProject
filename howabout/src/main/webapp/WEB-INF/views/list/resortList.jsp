		...
		<!-- 	<h4 style="margin-left: 20px; margin-top: 20px;">상세조건</h4>
			...
			<section style="margin-left: 20px;">
				<hr  color="#f5ebc4">
					<strong>평점</strong>
					<ul>
						<li><input type="checkbox" id="adcno_0" name="adcno[]" class="inp_chk" value="1"> <label for="adcno_0" class="label_chk">9.0이상</label></li>
						<li><input type="checkbox" id="adcno_1" name="adcno[]" class="inp_chk" value="2"> <label for="adcno_1" class="label_chk">8.0이상</label></li>
						<li><input type="checkbox" id="adcno_2" name="adcno[]" class="inp_chk" value="4"> <label for="adcno_2" class="label_chk">7.0이상</label></li>
					</ul>
				<hr  color="#f5ebc4">
			</section>
		 -->
                ...
                <a href="/detail/${resort.id}">
                    <div class="sex">
                        ...
                        <div class="text" style="color: black; width: 650px; height: 300px; margin: auto; margin-top: 90px; ">
                            <p style="margin-left: 15px; color:  #fff; font-weight: bold; font-size: 50px; margin-left: 1px;">${resort.name}</p>
                            <p style="color: rgb(255,167,38); font-weight: bold; font-size: 20px;"> &nbsp &nbsp &nbsp ${resort.level}</p>
                            <p style="color:#40392f; font-weight: bold; font-size: 20px;" >${resort.location}</p>
                        </div>
                    </div>
