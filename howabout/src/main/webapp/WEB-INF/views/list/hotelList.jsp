                ...
                <a href="/detail/${hotel.id}">
                    <div class="sex">
                        ...
                        <div class="text" style="color: black; width: 650px; height: 300px; margin: auto; margin-top: 90px; ">
                            <p style="margin-left: 15px; color:  #fff; font-weight: bold; font-size: 50px; margin-left: 1px;">${hotel.name}</p>
                            <p style="color: rgb(255,167,38); font-weight: bold; font-size: 20px;"> &nbsp &nbsp &nbsp ${hotel.level}</p>
                            <p style="color:#40392f; font-weight: bold; font-size: 20px;" >${hotel.location}</p>
                        </div>
                    </div>
