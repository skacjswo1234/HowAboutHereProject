...
<body>
	<div class="container" style="margin-top: 100px;">
		...
		<form action="/user/${principal.id}" method="post">
			...
			<input class="btn btn-info" type="button" onClick="goPopup();"style="background-color: #f7323f; border-color: #f7323f; color: #fff;" value="주소찾기" />
			<div class="form-group">
			...
			<button type="submit" class="btn btn-primary" style="background-color: #f7323f; border-color: #f7323f; color: #fff;">회원수정</button>
		</form>
	</div>
