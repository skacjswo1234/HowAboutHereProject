...
<div>
<button type="button" style="margin-top: 60px; float: right; margin-right: 200px; background-color: #f7323f; border: 3px solid #f7323f; color: #fff;"><a href="/saveAfter">후기작성하기</a></button>
</div>
<br>
<div class="container">
